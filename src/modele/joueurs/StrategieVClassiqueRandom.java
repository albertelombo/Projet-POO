...
/**
 * This class represents the random strategy used in the normal ShapeUp scenario
 * 
 * @author Albert&Christian
 *
 */
public class StrategieVClassiqueRandom implements Strategie {
	...
	public Integer[] choisirMeilleureOption( Joueur joueur) {
		...
		System.out.println("Je choisis l'option: "+ (meilleureOption[0] - plateau.getD1Neg())+";"+(meilleureOption[1] - plateau.getD2Neg()));
